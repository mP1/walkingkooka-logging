 ...
 * </pre>
 */
final class CanLogSharedPrinter extends CanLogShared<Printer> {

    static CanLogSharedPrinter with(final Printer printer) {
        return new CanLogSharedPrinter(
            Objects.requireNonNull(printer, "printer")
        );
    }

    private CanLogSharedPrinter(final Printer printer) {
        super(printer);
    }
